...
function Nettbutikk() {
  return (
    <PortfolioLayout
      ...
      reflections="Dette prosjektet er det første react prosjektet jeg har gjort med en gitt API. Det viktigste med dette prosjektet var å få koden til å fungere: Altså at nettsiden skulle fungere i forhold til søking og kjøping av de 25 tilgjengelige produktene. I ettertid er mitt største forbedringspotensial i dette prosjektet designen av nettsiden. Blåfargen får siden til å se halvferdig ut."
